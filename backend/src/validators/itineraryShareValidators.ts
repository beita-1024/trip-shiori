 ...
 * 共有設定作成のバリデーションスキーマ
 */
export const createItineraryShareSchema = z
  .object({
 ...
 */
export const updateItineraryShareSchema = z
  .object({
 ...
 * 共有設定作成のリクエスト型
 */
export type CreateItineraryShareRequest = z.infer<
  typeof createItineraryShareSchema
>;

/**
 * 共有設定更新のリクエスト型
 */
export type UpdateItineraryShareRequest = z.infer<
  typeof updateItineraryShareSchema
>;
