...
output "secret_names" {
  ...
  value = {
    ...
    refresh_token_fingerprint_secret = data.google_secret_manager_secret.refresh_token_fingerprint_secret.secret_id
...
output "secret_ids" {
  ...
  value = {
    ...
    refresh_token_fingerprint_secret = data.google_secret_manager_secret.refresh_token_fingerprint_secret.name
